...
public class AirlineCheckinSim {
	...
	private void enterData()
	{
		...
		System.out.println("Frequent flyer arrivals per hour: ");
		frequentFlyerQueue.setArrivalRate(input.nextDouble());
		System.out.println("Regular passenger arrivals per hour: ");
		regularPassengerQueue.setArrivalRate(input.nextDouble());
		System.out.println("Maximum number of frequent flyers served between regular passengers: ");
		frequentFlyerMax = input.nextInt();
		...
		String yesnt = input.next();
		if (yesnt.startsWith("Y")||yesnt.startsWith("y"))
			{
				showAll = true;
			}
		else
